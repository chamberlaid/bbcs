...
// Milestones for unlocking backgrounds
const milestones = [5, 10, 25, 50, 70, 80];

// Show unlocked backgrounds
unlockedBackgrounds.forEach(milestone => {
    const index = milestones.indexOf(milestone); // Get the correct index for the milestone
    const backgroundPath = availableBackgrounds[index]; // Use the correct background path
...
// Change background in both cosmetic page and game page
function changeBackground(backgroundPath) {
    // Change background on the cosmetic page
